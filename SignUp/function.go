...
func init() {
	functions.HTTP("Catatan", Catatan_register)
}

func Catatan_register(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, module.SignUpHandler("MONGOSTRING", "db_note", "user", r))
